...
var V2_FACTORY_ADDRESSES = (_V2_FACTORY_ADDRESSES = {}, _V2_FACTORY_ADDRESSES[ChainId.COSTON2] = '0x06B7a5aed878f639273d0e89fed525F26Ce59879', _V2_FACTORY_ADDRESSES);
/**
 * @deprecated use V2_ROUTER_ADDRESSES instead
 */

var V2_ROUTER_ADDRESS = '0xB2a25D010fE4b7f37066432F19a4AA8d29951EC8';
var V2_ROUTER_ADDRESSES = (_V2_ROUTER_ADDRESSES = {}, _V2_ROUTER_ADDRESSES[ChainId.COSTON2] = '0xB2a25D010fE4b7f37066432F19a4AA8d29951EC8', _V2_ROUTER_ADDRESSES);
var COSTON2_ADDRESSES = {
  multicallAddress: "0x411E2E15390639Cd553508907329Ea95F23D9Bf0"
};
var PERMIT2_ADDRESS = "0x3CE3deF8d48d0D620061e5F0330a742B28B5945e";
var PERMIT2_ADDRESS_MAP = (_PERMIT2_ADDRESS_MAP = {}, _PERMIT2_ADDRESS_MAP[ChainId.COSTON2] = "0x3CE3deF8d48d0D620061e5F0330a742B28B5945e", _PERMIT2_ADDRESS_MAP);
var UNIVERSAL_ROUTER = (_UNIVERSAL_ROUTER = {}, _UNIVERSAL_ROUTER[ChainId.COSTON2] = "0x04F886Aed8B7Fc774535E6DEcaaFd3F2B63BB653", _UNIVERSAL_ROUTER);
...
var CHAIN_TO_ADDRESSES_MAP = (_CHAIN_TO_ADDRESSES_M = {}, _CHAIN_TO_ADDRESSES_M[ChainId.COSTON2] = COSTON2_ADDRESSES, _CHAIN_TO_ADDRESSES_M);
...
var OracleSwapVoter = (_OracleSwapVoter = {}, _OracleSwapVoter[ChainId.COSTON2] = '0x85Fc3Aa730Df4AFb98c2f8705704452B90D112F4', _OracleSwapVoter);
var OSLPManager = (_OSLPManager = {}, _OSLPManager[ChainId.COSTON2] = '0xf2E3BEAE2C9DF795454510010BF3597453AFbf68', _OSLPManager);
var SuperfarmMultiRewardManager = (_SuperfarmMultiReward = {}, _SuperfarmMultiReward[ChainId.COSTON2] = '0x3f2adA4Ee22d60CbaA7AbaB8Ac4c61c25ef31485', _SuperfarmMultiReward);
var FTSORewardManager = (_FTSORewardManager = {}, _FTSORewardManager[ChainId.COSTON2] = '0x16E6A0b7a26518c336Bca0E935782C22A9EE07Fd', _FTSORewardManager[ChainId.FLARE] = '0x85627d71921AE25769f5370E482AdA5E1e418d37', _FTSORewardManager[ChainId.SONGBIRD] = '0x13F7866568dC476cC3522d17C23C35FEDc1431C5', _FTSORewardManager);
var FTSOManager = (_FTSOManager = {}, _FTSOManager[ChainId.COSTON2] = '0x4F52e61907B0ED9f26b88F16B2510a4CA524d6d0', _FTSOManager[ChainId.FLARE] = '0x2E99a4543F9ea708Cf8CCaC447515e61706D9DE9', _FTSOManager[ChainId.SONGBIRD] = '0x7A6B15E17b7691ba687ad182bD12cb4a91D533ae', _FTSOManager);
var ClaimSetupManager = (_ClaimSetupManager = {}, _ClaimSetupManager[ChainId.COSTON2] = '0x5Ddb590530EF66775E6225671eaBD94959e9AE0e', _ClaimSetupManager[ChainId.FLARE] = '0xD56c0Ea37B848939B59e6F5Cda119b3fA473b5eB', _ClaimSetupManager[ChainId.SONGBIRD] = '0xDD138B38d87b0F95F6c3e13e78FFDF2588F1732d', _ClaimSetupManager);
var DistributionToDelegators = (_DistributionToDelega = {}, _DistributionToDelega[ChainId.COSTON2] = '0xbd33bDFf04C357F7FC019E72D0504C24CF4Aa010', _DistributionToDelega[ChainId.FLARE] = '0x9c7A4C83842B29bB4A082b0E689CB9474BD938d0', _DistributionToDelega);
var FTSORegistry = (_FTSORegistry = {}, _FTSORegistry[ChainId.COSTON2] = '0x48da21ce34966a64e267cefb78012c0282d0ac87', _FTSORegistry[ChainId.FLARE] = '0x13DC2b5053857AE17a4f95aFF55530b267F3E040', _FTSORegistry[ChainId.SONGBIRD] = '0xef4c203470553c654b3870f37ce4de1fa862dee0', _FTSORegistry);
var INIT_CODE_HASH = (_INIT_CODE_HASH = {}, _INIT_CODE_HASH[ChainId.COSTON2] = "0xae199cf6bedaa27fee9ef8928dd16925c3846fbe0532e42bbdee6de014e9bef9", _INIT_CODE_HASH);
var MULTICALL2_ADDRESS = (_MULTICALL2_ADDRESS = {}, _MULTICALL2_ADDRESS[ChainId.COSTON2] = "0x35060f7803eF7763b77E4EF0082bc0bCf2654154", _MULTICALL2_ADDRESS[ChainId.FLARE] = '0x1240C3f2D9d20951C8d338548c6F79315cD007A3', _MULTICALL2_ADDRESS[ChainId.SONGBIRD] = '0x9f3C3e294ea78319CCD16589eB9e8Ab24BBCF613', _MULTICALL2_ADDRESS);
/**
...
var GOVERNANCE_BRAVO_ADDRESSES = (_GOVERNANCE_BRAVO_ADD = {}, _GOVERNANCE_BRAVO_ADD[ChainId.COSTON2] = '0xCCf16d8F755e7e2f09670eb88F3e3ae1ab787fDB', _GOVERNANCE_BRAVO_ADD);
var TIMELOCK_ADDRESSES = (_TIMELOCK_ADDRESSES = {}, _TIMELOCK_ADDRESSES[ChainId.COSTON2] = '0xCFC76Aa3af550D99d486701b22288237b2B8F043', _TIMELOCK_ADDRESSES);
...
var WETH9 = (_WETH = {}, _WETH[114] = /*#__PURE__*/new Token(114, '0xc67dce33d7a8efa5ffeb961899c73fe01bce9273', 18, 'WC2FLR', 'Wrapped C2FLR'), _WETH);
...
export { CHAIN_TO_ADDRESSES_MAP, ChainId, ClaimSetupManager, CurrencyAmount, DistributionToDelegators, ENS_REGISTRAR_ADDRESSES, Ether, FTSOManager, FTSORegistry, FTSORewardManager, Fraction, GOVERNANCE_ALPHA_V0_ADDRESSES, GOVERNANCE_ALPHA_V1_ADDRESSES, GOVERNANCE_BRAVO_ADDRESSES, INIT_CODE_HASH, MIXED_ROUTE_QUOTER_V1_ADDRESSES, MULTICALL2_ADDRESS, MULTICALL_ADDRESSES, MaxUint256, NONFUNGIBLE_POSITION_MANAGER_ADDRESSES, NativeCurrency, NativeCurrencyName, OSLPManager, OracleSwapVoter, PERMIT2_ADDRESS, PERMIT2_ADDRESS_MAP, Percent, Price, QUOTER_ADDRESSES, Rounding, SOCKS_CONTROLLER_ADDRESSES, SUPPORTED_CHAINS, SuperfarmMultiRewardManager, TICK_LENS_ADDRESSES, TIMELOCK_ADDRESSES, Token, TradeType, UNISWAP_NFT_AIRDROP_CLAIM_ADDRESS, UNIVERSAL_ROUTER, UNIVERSAL_ROUTER_ADDRESS, UNI_ADDRESSES, V2_FACTORY_ADDRESS, V2_FACTORY_ADDRESSES, V2_ROUTER_ADDRESS, V2_ROUTER_ADDRESSES, V3_CORE_FACTORY_ADDRESSES, V3_MIGRATOR_ADDRESSES, WETH9, computePriceImpact, sortedInsert, sqrt, validateAndParseAddress };
